...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const renderMovies = async page => {
    ...
    movies.forEach(movie => {
      ...
      card.style.background = movie.poster_path ? `url(https://image.tmdb.org/t/p/w500${movie.poster_path}) center/cover` : 'url(src/img/poster-placeholder.jpg) center/cover';
